...
loglog(Rslt.beta, abs(-Rslt.LnZ./Rslt.beta - Fe')./(abs(Fe)'), '-o', 'linewidth', 2, 'color', color_list{1}); hold on

Rslt = loadRslt(100, 'tanTRG');
[Fe, En, Cm, S] = FreeFermion_1Ddst(50, Rslt.beta);
loglog(Rslt.beta, abs(-Rslt.LnZ./Rslt.beta - Fe')./(abs(Fe)'), '-o', 'linewidth', 2, 'color', color_list{2}); hold on

Rslt = loadRslt(200, 'tanTRG');
[Fe, En, Cm, S] = FreeFermion_1Ddst(50, Rslt.beta);
loglog(Rslt.beta, abs(-Rslt.LnZ./Rslt.beta - Fe')./(abs(Fe)'), '-o', 'linewidth', 2, 'color', color_list{3}); hold on


Rslt = loadRslt(50, 'XTRG');
[Fe, En, Cm, S] = FreeFermion_1Ddst(50, Rslt.beta);
loglog(Rslt.beta, abs(-Rslt.LnZ./Rslt.beta - Fe)./(abs(Fe)), '-s', 'linewidth', 2, 'color', color_list{4}); hold on
 
Rslt = loadRslt(100, 'XTRG');
[Fe, En, Cm, S] = FreeFermion_1Ddst(50, Rslt.beta);
loglog(Rslt.beta, abs(-Rslt.LnZ./Rslt.beta - Fe)./(abs(Fe)), '-s', 'linewidth', 2, 'color', color_list{5}); hold on
