function [ Lattice, ModelConf ] = SpinModel_KagomeHei( )
% -------------------------------------------------------------
% Triangular lattice
% XXZ model
% Parameter:
...
% DEFAULT SETTINGS
% =============================================================
ModelConf.ModelName = 'KagomeHei';
ModelConf.ModelName_Full = 'Kagome Heisenberg Model';
ModelConf.IntrcMap = 'IntrcMap_KagomeHei';
...
Lattice.BCX = 'OBC';
Lattice.BCY = 'OBC';
Lattice.L = 3 * Lattice.Lx * Lattice.Ly;
