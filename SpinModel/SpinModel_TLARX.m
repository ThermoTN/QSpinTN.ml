function [ Lattice, ModelConf ] = SpinModel_TLARX( )
% -------------------------------------------------------------
% Triangular lattice
% XXZ model
% Parameter:
...
ModelConf.IntrcMap = 'IntrcMap_TLARX';       % C3 Yuan Wan
...
ModelConf.Para_Name = {'J1xy'; 'J1z'; 'JPD'; 'JGamma'; 'J2xy'; 'J2z'};
% Parameters' unit
...
ModelConf.Para_Unit = {'K'; 'K'; 'K'; 'K'; 'K'; 'K'};
...
% =============================================================
% J1xy range
ModelConf.Para_Range{1} = [-0.2, 0.2];
% J1z range
ModelConf.Para_Range{2} = [-0.2, 0.2];
% JPD range
ModelConf.Para_Range{3} = [-0.2, 0.2];
% JGamma rang4
ModelConf.Para_Range{4} = [0, 0.2];
% J2xy range
ModelConf.Para_Range{5} = 0;
% J2z range
ModelConf.Para_Range{6} = 0;
% gx range
ModelConf.gFactor_Range{1} = 2;
% gy range
ModelConf.gFactor_Range{2} = 2;
% gz range
ModelConf.gFactor_Range{3} = [1,4];
end
