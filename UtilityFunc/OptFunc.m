...
for i = 1:1:OptPara.Group_Number
    if i == 1 && judge == 0
        ...
        switch OptPara.Parallel
            ...
            case 'on'
                ...
                spmd
                    ...
                    fun = makeFun(labindex, TStr, gFac_input, Para_input, QMagenConf);
                end
            ...
            case 'off'
                ...
                lf = @(x) loss_func(TStr, eval(gFac_input), eval(Para_input), QMagenConf);
        ...
        save(['../Tmp/',  QMagenConf.Setting.SAVEFILENAME, TStr, '/res', num2str(i), '.mat'],'res');
    elseif i == 1 && judge == 1
...
function f = makeFun(labindex, TStr, gFac_input, Para_input, QMagenConf)
f = @fun;
TStr = [num2str(labindex), TStr];
    function lf = fun(x)
        lf = loss_func( TStr, eval(gFac_input), eval(Para_input), QMagenConf);
    end
end
